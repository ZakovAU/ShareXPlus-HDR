...
Source: "{#MyAppReleaseDirectory}\ShareX.runtimeconfig.json"; DestDir: {app}; Flags: ignoreversion
Source: "{#MyAppReleaseDirectory}\ShareX.deps.json"; DestDir: {app}; Flags: ignoreversion
